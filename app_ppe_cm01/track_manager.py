...
import time
from configs import *
from utils import current_milli_time, letterbox
...
class DataRequest():
    ...
    status: str
    violate: bool
    def __init__(self, track_id, image, status, violate) -> None:
        self.track_id = track_id
        self.image = image
        self.status = status
    ...
    def run(self):
        while True:
            ...
            message = {
                ...
                'display_events': ['CM01'] #['face', 'face-CM03']
            }
